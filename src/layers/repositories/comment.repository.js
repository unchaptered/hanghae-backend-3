...
class CommentRepository {
     ...
     */
    getComment = async (poolConnection) => {
     ...
     */
    getCommentById = async (poolConnection, commentId) => {
     ...
     */
    createComment = async (poolConnection, userId, articleId, content) => {
     ...
     */
    updateCommentById = async (poolConnection, commentId, content) => {
     ...
     * @returns { Promise< boolean> }
     */
    deleteCommentById = async (poolConnection, commentId) => {
    ...
    isExists = async (poolConnection, commentId) => {
    ...
    isLikeExists = async (poolConnection, userId, commentId) => {
    ...
    createCommentLike = async (poolConnection, userId, commentId, isLike) => {
    ...
    updateCommentLike = async (poolConnection, userId, commentId, isLike) => {
